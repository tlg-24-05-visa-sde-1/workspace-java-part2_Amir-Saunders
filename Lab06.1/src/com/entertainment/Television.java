...
public class Television implements Comparable<Television> {
    ...
    //static nested classes these can be reference with Television.
    //Outside this class (Television) , DispayType is still visible
    //it's name is televison.displaytype
