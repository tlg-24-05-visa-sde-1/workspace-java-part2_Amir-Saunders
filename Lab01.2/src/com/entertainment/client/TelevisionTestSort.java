...
public class TelevisionTestSort {
    ...
    public static void main(String[] args) {
        ...
        tvList.sort(null);
        /*This calls the compare to method from Televison that exetnds comparable and we made the natural order brand by specifying it in the cpmapre to method*/
       ...
       //  TODO: uncomment this to test your comparator class
        ...
        for (Television tv : tvList) {
          System.out.println(tv);
//          when you sout an object it automatiaclly calls the toString method.
        }
        System.out.println();
